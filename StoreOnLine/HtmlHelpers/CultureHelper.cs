...
namespace StoreOnLine.HtmlHelpers
{
    public static class CultureHelper
    {
        ...
        // Incluye las culturas que se va a implementar
        private static readonly List<string> Cultures = new List<string> {
        "en-US",  // Ingles por default
        "es-PE", // Español NEUTRAL culture
        "es"  // Arabico NEUTRAL culture
        
    };
        /// <summary>
        /// Retorna true si el lenguaje es de derecha a izquierda
        ...
        /// <summary>
        /// Retorna una cultura valida basada por el parametro name
        /// Si name no es valido retorna la cultura por default "en-US"
        /// </summary>
