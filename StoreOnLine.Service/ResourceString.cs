    ...
    public class ResourceString
    {
        ...
        private static string GetResourceByTypeAndKey(string resourceType, string resourceKey)
        {
            ...
            if (resources.Count == 0)
            {
                ...
                var lr = new DataBase.CMS.LocalizeResources { CultureId = CultureInfo.CurrentCulture.TwoLetterISOLanguageName, ResourceType = resourceType, ResourceKey = resourceKey, ResourceValue = resourceValue };
